...
public class ApiUtil {
	...
	public CustomResponse getAllStocks(String endpoint, Object body) {
		...
		Response response = ce.getResponse(url);

		int statusCode = ce.getStatusCode(response);
		String status = ce.getStatusLine(response);
		List<Map<String, Object>> results = ce.getResultsList(response,"Results");
